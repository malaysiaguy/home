...
function Main() {
    ...
    return (
        <Container className='text-light p-0'>
            <Row className='g4'>
                <Col className='col-md-4 mb-3 p-0'>
            ...
            <Row className='g4'>
                <Col className='col-md-12 mb-3 p-0'>
                    <Card className='p-1 bg-success text-light' style={{ height: '100%' }}>
